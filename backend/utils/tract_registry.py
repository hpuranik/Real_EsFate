...
TRACT_REGISTRY: Dict[str, dict] = {
    ...
    # Phase 1 additions (new neighborhoods requested)
    # Each entry uses a real 11-digit FIPS GEOID as the canonical tract.
    # Sources: City of Pittsburgh tract maps / Census tract lookup (see project notes).
    ...
    "42003080300": {
        "name": "East Liberty",
        "canonical": True,
        "all_tracts": ["42003080300"],
        "display_order": 11,
    },
    "42003080400": {
        "name": "Bloomfield",
        "canonical": True,
        "all_tracts": ["42003080400"],
        "display_order": 12,
    },
    "42003080500": {
        "name": "Garfield",
        "canonical": True,
        "all_tracts": ["42003080500"],
        "display_order": 13,
    },
    "42003130200": {
        "name": "Polish Hill",
        "canonical": True,
        "all_tracts": ["42003130200"],
        "display_order": 14,
    },
    "42003080730": {
        "name": "Friendship",
        "canonical": True,
        "all_tracts": ["42003080730"],
        "display_order": 15,
    },
    "42003512700": {
        "name": "Regent Square",
        "canonical": True,
        "all_tracts": ["42003512700"],
        "display_order": 16,
    },
    "42003050600": {
        "name": "Mt. Washington",
        "canonical": True,
        "all_tracts": ["42003050600"],
        "display_order": 17,
    },
    "42003060100": {
        "name": "Beechview",
        "canonical": True,
        "all_tracts": ["42003060100"],
        "display_order": 18,
    },
    "42003500200": {
        "name": "Carrick",
        "canonical": True,
        "all_tracts": ["42003500200"],
        "display_order": 19,
    },
    "42003130600": {
        "name": "Greenfield",
        "canonical": True,
        "all_tracts": ["42003130600"],
        "display_order": 20,
    },
    "42003040600": {
        "name": "CMU/Oakland",
        "canonical": True,
        "all_tracts": ["42003040600"],
        "display_order": 21,
    },
    "42003140100": {
        "name": "Point Breeze",
        "canonical": True,
        "all_tracts": ["42003140100"],
        "display_order": 22,
    },
    "42003562400": {
        "name": "Homewood",
        "canonical": True,
        "all_tracts": ["42003562400", "42003562300", "42003562500"],
        "display_order": 23,
    },
    "42003082000": {
        "name": "Stanton Heights",
        "canonical": True,
        "all_tracts": ["42003082000"],
        "display_order": 24,
    },
}
